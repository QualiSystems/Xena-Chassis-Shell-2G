...
class XenaChassisShell2G(object):
    ...
    def password(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.Password"] if "Xena Chassis Shell 2G.Password" in self.attributes else None
        )
    ...
    def controller_tcp_port(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.Controller TCP Port"]
            if "Xena Chassis Shell 2G.Controller TCP Port" in self.attributes
            else None
        )
    ...
    def controller_address(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.Controller Address"]
            if "Xena Chassis Shell 2G.Controller Address" in self.attributes
            else None
        )
    ...
    def client_install_path(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.Client Install Path"]
            if "Xena Chassis Shell 2G.Client Install Path" in self.attributes
            else None
        )
    ...
    def power_management(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.Power Management"]
            if "Xena Chassis Shell 2G.Power Management" in self.attributes
            else None
        )
    ...
    def serial_number(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.Serial Number"]
            if "Xena Chassis Shell 2G.Serial Number" in self.attributes
            else None
        )
    ...
    def server_description(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.Server Description"]
            if "Xena Chassis Shell 2G.Server Description" in self.attributes
            else None
        )
...
class GenericTrafficGeneratorModule(object):
    ...
    def version(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.GenericTrafficGeneratorModule.Version"]
            if "Xena Chassis Shell 2G.GenericTrafficGeneratorModule.Version" in self.attributes
            else None
        )
    ...
    def serial_number(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.GenericTrafficGeneratorModule.Serial Number"]
            if "Xena Chassis Shell 2G.GenericTrafficGeneratorModule.Serial Number" in self.attributes
            else None
        )
...
class GenericTrafficGeneratorPort(object):
    ...
    def media_type(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.GenericTrafficGeneratorPort.Media Type"]
            if "Xena Chassis Shell 2G.GenericTrafficGeneratorPort.Media Type" in self.attributes
            else None
        )
...
class GenericPowerPort(object):
    ...
    def model(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.GenericPowerPort.Model"]
            if "Xena Chassis Shell 2G.GenericPowerPort.Model" in self.attributes
            else None
        )
    ...
    def serial_number(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.GenericPowerPort.Serial Number"]
            if "Xena Chassis Shell 2G.GenericPowerPort.Serial Number" in self.attributes
            else None
        )
    ...
    def version(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.GenericPowerPort.Version"]
            if "Xena Chassis Shell 2G.GenericPowerPort.Version" in self.attributes
            else None
        )
    ...
    def port_description(self):
        ...
        """
        return (
            self.attributes["Xena Chassis Shell 2G.GenericPowerPort.Port Description"]
            if "Xena Chassis Shell 2G.GenericPowerPort.Port Description" in self.attributes
            else None
        )
